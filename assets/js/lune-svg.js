...
wrapper.innerHTML = `
  <svg id="svg-lune" viewBox="0 0 100 100" width="100%" height="100%">
    <defs>
      <!-- Filtre pour la lune fantôme -->
      <filter id="lune-fantome" x="0" y="0" width="100%" height="100%">
        <feComponentTransfer>
          <feFuncA type="table" tableValues="0 0.08"/> <!-- 8% d'opacité -->
        </feComponentTransfer>
